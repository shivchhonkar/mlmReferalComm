...
export default function IncomeReportsPayoutsPage() {
  ...
  const fileBase = `customers-income-payouts-${status}-${new Date().toISOString().slice(0, 10)}`;
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm sm:p-6">
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <ReportExportButtons
          reportTitle="Customers Income — Payouts & Withdrawals"
                ...
                <Fragment key={w._id}>
                  <tr className="border-b border-zinc-100">
                    <td className="px-3 py-3">
                      ...
                      {uid ? (
                        <Link
                          href={`/dashboard/admin/reports/customers-income-reports/${uid}`}
