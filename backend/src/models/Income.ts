...
const incomeSchema = new Schema(
  {
    ...
    /** Direct-referral leg root for per-leg withdrawal cap (earner's child on path from buyer). */
    legRootUserId: { type: Schema.Types.ObjectId, ref: "User", default: null, index: true },
  },
  { timestamps: true }
);
